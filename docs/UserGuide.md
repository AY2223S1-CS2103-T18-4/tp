...
be free to meet up to do group projects. You can also filter by modules to help you find friends who are currently
...
potential** of ConnectNUS and capitalise on the features ConnectNUS has in store for you to make your CS experience
**better than better**.
...
User Guide, so you will  navigate it with ease.
...
You can jump into the various sections to learn about all related commands to the respective features.
